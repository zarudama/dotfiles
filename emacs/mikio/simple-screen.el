...
(define-key simple-screen-map "k" 'simple-screen-clear-screen)
(define-key simple-screen-map "1" 'simple-screen-0)
(define-key simple-screen-map "2" 'simple-screen-1)
(define-key simple-screen-map "3" 'simple-screen-2)
(define-key simple-screen-map "4" 'simple-screen-3)
(define-key simple-screen-map "5" 'simple-screen-4)
(define-key simple-screen-map "6" 'simple-screen-5)
(define-key simple-screen-map "7" 'simple-screen-6)
(define-key simple-screen-map "8" 'simple-screen-7)
(define-key simple-screen-map "9" 'simple-screen-8)
(define-key simple-screen-map "0" 'simple-screen-9)
